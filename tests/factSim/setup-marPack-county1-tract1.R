...
# setup marPack
marPack = vector("list",72) # 72 margins for tract 1 and county 1
...
for(i in 1:1){ # tract levels ONLY TRACT 1
...
for(i in 1:1){ # county levels ONLY COUNTY 1
  for(j in 1:3){ # age levels
    for(k in 1:2){ # sex levels
